...
public class HeartRate {
    ...
    public static void main(String[] args){
        ...
        int lowOutput = (CONST_VALUE - age) * LOW_THRESHOLD / 100;
        int highOutput = (CONST_VALUE - age) * HIGH_THRESHOLD / 100;
        System.out.printf("Your estimated target heart rate zone is %d – %d beats per minute.", lowOutput, highOutput); // print heart rate after calculation
    } // end of main method
} // end of class
